...
import reflex as rx
from .views.edit import edit_ui
from .views.edit import export_data_button
        ...
        rx.tabs.root(
            rx.tabs.list(
                ...
                _tabs_trigger("Stats", "bar-chart-3", value="stats"),
                 _tabs_trigger("Edit", "pencil", value="edit"),
...
app.add_page(
    ...
    title="FOOTBALL DATA",
    description="Football Data for the 2021-2024 seasons.",
)
